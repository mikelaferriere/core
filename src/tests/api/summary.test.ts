      ...
      expect(actual).toStrictEqual([
        {
          ...
          result: {
            awayScore: 1,
            description: "Garver singled to center, Seager scored, Carter to third.",
            homeScore: 0,
            team: {
              id: "13"
            }
        ...
        },
        {
          ...
          result: {
            awayScore: 3,
            description: "Heim singled to center, Jung scored. Lowe scored on fielding error by center fielder Thomas, Heim to third.",
            homeScore: 0,
            team: {
              id: "13"
            }
        ...
        expect(actual).toStrictEqual([
            {
              ...
              result: {
                awayScore: 0,
                description: "W.Lutz 31 yard field goal is GOOD, Center-M.Fraboni, Holder-R.Dixon.",
                homeScore: 3,
                team: undefined
              },
              scoringTeam: "home"
            },
            {
              ...
              result: {
                awayScore: 7,
                description: "J.Dobbs pass short right to J.Oliver for 3 yards, TOUCHDOWN [Z.Allen]. G.Joseph extra point is GOOD, Center-A.DePaola, Holder-R.Wright.",
                homeScore: 3,
                team: undefined
              },
              scoringTeam: "away"
            },
            {
              ...
              result: {
                awayScore: 10,
                description: "G.Joseph 34 yard field goal is GOOD, Center-A.DePaola, Holder-R.Wright.",
                homeScore: 3,
                team: undefined
              },
              scoringTeam: "away"
      ...
      expect(actual).toStrictEqual([
        {
          ...
          result: {
            awayScore: 1,
            description: "Jake Neighbours Goal (4) Slap Shot, assists: Oskar Sundqvist (6)",
            homeScore: 0,
            team: {
              id: "19"
            }
        ...
        },
        {
          ...
          result: {
            awayScore: 2,
            description: "Pavel Buchnevich Goal (6) Snap Shot, assists: Jordan Kyrou (6), Scott Perunovich (1)",
            homeScore: 0,
            team: {
              id: "19"
            }
        ...
        },
        {
          ...
          result: {
            awayScore: 3,
            description: "Alexey Toropchenko Goal (3) Snap Shot, assists: Justin Faulk (9), Kevin Hayes (5)",
            homeScore: 0,
            team: {
              id: "19"
            }
